...
- **Блокировать глобально или просто переключать** — задайте глобальному источнику ввода по умолчанию одно из трёх поведений: *блокировать*, чтобы закрепить его везде; *переключать*, чтобы один раз переключить вас на него при входе в любое приложение без собственного правила, а затем оставить вас свободными (срабатывая заново на каждом новом приложении без правила); или **Нет**, чтобы не закреплять ничего и работать как чистый переключатель для отдельных приложений и сайтов. *Переключать* активно переключает вас на него в каждом приложении без правила; **Нет** не делает глобально ничего.
