...
- **Verrouiller globalement, ou simplement basculer** — attribuez à la source de saisie par défaut globale l'un de trois comportements : *verrouiller* pour l'épingler partout ; *basculer* pour vous y faire basculer une fois en entrant dans une application sans règle propre, puis vous laisser libre (se redéclenchant à chaque nouvelle application sans règle) ; ou **Aucune** pour n'épingler quoi que ce soit et agir comme un pur commutateur par application/par site. *Basculer* vous fait activement basculer sur chaque application sans règle ; **Aucune** ne fait rien globalement.
