...
- **Global sperren oder einfach wechseln** — gib der globalen Standard-Eingabequelle eines von drei Verhalten: *sperren*, um sie überall zu fixieren; *wechseln*, um dich einmalig hineinzuschalten, sobald du eine App ohne eigene Regel betrittst, und dich danach frei wählen zu lassen (löst bei jeder neuen App ohne Regel erneut aus); oder **Keine**, um gar nichts zu fixieren und als reiner Umschalter pro App/pro Seite zu wirken. *Wechseln* schaltet dich bei jeder App ohne Regel aktiv hinein; **Keine** tut global nichts.
